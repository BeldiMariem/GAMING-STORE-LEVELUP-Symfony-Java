...
// Déclaration des variables utilisées
    ...
    public void initialize(URL url, ResourceBundle rb
        ...
        myCircle1.setStroke(javafx.scene.paint.Color.SEAGREEN);
...
//                    System.out.println(selectedProduit);
                    ...
                    String z = String.valueOf(selectedProduit.getPrixProd());
                    prixTF.setText(z);
                    ...
                    calculProm.setOnAction(
                            event -> {
                                showAlert(Alert.AlertType.INFORMATION, ((Node) event.getSource()).getScene().getWindow(),
                                        "Calcul de la Promotion ", " Le prix final aprés le calcul de la promotion est : " + (sp.calculerPromotion(jc))
                                );
                            }
                    );
                }
...
//                st.executeUpdate(req);
    ...
    private void generateQRCode(MouseEvent event) throws WriterException, IOException, InterruptedException {
        ...
        String filePath = "C:/Users/beldi/Desktop/Projet/Levelup/src/QR/ProduitQR.png";
        ...
        if (action.get() == ButtonType.OK) {
            ...
            if (showAlert(Alert.AlertType.INFORMATION, ((Node) event.getSource()).getScene().getWindow(),
                ...
                File f1 = new File("C:/Users/beldi/Desktop/Projet/Levelup/src/QR/ProduitQR.png");
...
//            stage.setScene(scene);
//            stage.show();
            String barCodePath = "C:/Users/beldi/Desktop/Projet/Levelup/src/QR/";
            ...
            File f = new File("C:/Users/beldi/Desktop/Projet/Levelup/src/QR/" + nomProduitTF.getText() + " Barcode.JPG");
    ...
    private void visitDB(MouseEvent event) throws IOException {
        Writer writer = null;
        File file = new File("C:\\Users\\beldi\\Desktop\\Projet\\Levelup\\src\\QR\\Produit.csv.");
        ...
        if (action.get() == ButtonType.OK) {
            ...
            File f = new File("C:\\Users\\beldi\\Desktop\\Projet\\Levelup\\src\\QR\\Produit.csv.");
            Desktop d = Desktop.getDesktop();
            d.open(f);
        }
    }
