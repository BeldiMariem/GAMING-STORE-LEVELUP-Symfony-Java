...
public class Commande {
   ...
   //Constructeur
    ...
    public Commande(int id_commande, User client, double prix_livraison, double prix_produits, double prix_total, Date date_commande) {
        this.id_commande = id_commande;
        this.client = client;
    ...
    public Commande(int id_commande, User client, float prix_livraison, Date date_commande) {
        this.id_commande = id_commande;
        this.client = client;
        this.prix_livraison = prix_livraison;
        this.date_commande = date_commande;
