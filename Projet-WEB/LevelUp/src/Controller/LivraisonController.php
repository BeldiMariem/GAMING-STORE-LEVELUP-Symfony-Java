...
class LivraisonController extends AbstractController
{
     ...
     * @Route("/addjson/{idUser}/{idCommande}", name="addJson")
     *
     */
    public function addLivraisonJson(NormalizerInterface $normalizer, Request $request, UserRepository $usr, CommandeRepository $Com
        ...
        $livraison->setIdUser($this->getDoctrine()->getManager()-> getRepository(  User::class)->find($idUser));
     ...
     * @return Response
     * @throws ExceptionInterface
     * @Route("/editjson/{idLivraison}" , name="editLivraisonJson")
     */
    public function editLivraisontJson(NormalizerInterface $normalizer, Request $request
        ,$idLivraison){
        $em=$this->getDoctrine()->getManager();
        $livraison = new Livraison();
     ...
     */
    public function indexBack(LivraisonRepository $livraisonRepository,UserRepository $userRepository,Request $request): Response
    {
        $LivId=3;
