...
{#use Knp\Component\Pager\PaginatorInterface;#}
    ...
    class FactureController extends AbstractController
    {
         ...
         * @Route("/editFactureJson/edit/{idFacture}" , name="editFacturejson")
         */
        public function editFactureJson(NormalizerInterface $normalizer, Request $request,$idFacture){
          ...
          //  $facture->setIdUser($user);
            ...
            $em->flush();
            $json_content = $normalizer->normalize($facture, 'json',['groups'=>'post:read']);
         ...
         * @return Response
         * @throws ExceptionInterface
         * @Route("/addFactureJson/add" , name="addFacturejson")
         */
        public function addDactureJson(NormalizerInterface $normalizer, Request $request){
            $em=$this->getDoctrine()->getManager();
            $facture = new Facture();
           // $user = new User();
           // $user = $usr->find($idUser);
            ...
            $facture->setIdUser($this->getDoctrine()->getManager()-> getRepository(  User::class)->find($idUser));
