...
// Fonction Modification json mobile
     ...
     */
    public function Top( PaginatorInterface $paginator,Request $request,UserRepository $userRepository,DetailCommandeRepository $detailCommandeRepository,PanierRepository $panier,UserRepository $user,PanierElemRepository $panierElemRepository,ProduitRepository $produitRepository): Response
    {
        $i = 0;
     ...
     */
    public function showpanier(StockRepository $stockrepo,$idProduit,Produit $produit,Request $request,UserRepository $userRepository,PanierRepository $panier,UserRepository $user,PanierElemRepository $panierElemRepository,ProduitRepository $produitRepository): Response
    {
